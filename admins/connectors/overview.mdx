...
- Confluence
- Jira
- Google Drive (use a service account; an OAuth credential mirrors only what the signed-in account can see)
...
By default there is no start date, so the first indexing attempt reads the source's entire history.
On a large source that first attempt can take days.
Set a start date when you create the connector if you only need recent content, or want the connector searchable sooner.
...
<Columns cols={3}>
  ...
  <Card title="SharePoint and OneDrive" icon="microsoft" href="/admins/connectors/official/microsoft-365/sharepoint" horizontal/>
  ...
  <Card title="Coda" icon="table" href="/admins/connectors/official/coda" horizontal/>
  ...
  <Card title="LumApps" icon="building" href="/admins/connectors/official/lumapps" horizontal/>

  <Card title="Outline" icon="book" href="/admins/connectors/official/outline" horizontal/>

  <Card title="Axero" icon="users" href="/admins/connectors/official/axero" horizontal/>

  <Card title="MediaWiki" icon="wikipedia-w" href="/admins/connectors/official/mediawiki" horizontal/>

  <Card title="Wikipedia" icon="wikipedia-w" href="/admins/connectors/official/wikipedia" horizontal/>

  <Card title="Loopio" icon="file-lines" href="/admins/connectors/official/loopio" horizontal/>
...
<Columns cols={3}>
  ...
  <Card title="TestRail" icon="clipboard-check" href="/admins/connectors/official/testrail" horizontal/>
...
<Columns cols={3}>
  ...
  <Card title="Microsoft Teams" icon="microsoft" href="/admins/connectors/official/microsoft-365/teams" horizontal/>

  <Card title="Gmail" icon="envelope" href="/admins/connectors/official/gmail/overview" horizontal/>

  <Card title="Outlook" icon="microsoft" href="/admins/connectors/official/microsoft-365/outlook" horizontal/>

  <Card title="Email (IMAP)" icon="envelope" href="/admins/connectors/official/imap" horizontal/>
...
<Columns cols={3}>
  ...
  <Card title="Braintrust" icon="flask" href="/admins/connectors/official/braintrust" horizontal/>
</Columns>
