...
<Steps>
  ...
  <Step title="Open settings">
    ...
    ![FirefliesConnectorAuth](/assets/admins/connectors/fireflies/fireflies1.png)
  </Step>

  <Step title="Open Developer Settings">
    Select **Developer Settings**.

    <img className="rounded-image" src="/assets/admins/connectors/fireflies/fireflies2.png" alt="FirefliesConnectorAuth" />
  </Step>

  <Step title="Copy API Key">
    Copy the **API Key**.

    <img className="rounded-image" src="/assets/admins/connectors/fireflies/fireflies3.png" alt="FirefliesConnectorAuth" />
  </Step>
