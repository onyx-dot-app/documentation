...
<img className="rounded-image" src="/assets/admins/connectors/google_drive/OAuthCredential.png" alt="Onyx Google Drive credential modal showing the OAuth app and service account options"/>
