...
<Steps>
  ...
  <Step title="Set up scopes">
    ...
    <img className="rounded-image" src="/assets/admins/connectors/google_drive/GoogleDriveScopes.png" alt="OAuth consent screen scopes for Google Drive, Admin SDK, Sheets, and Docs" width="60%" />
  </Step>
  ...
  <Step title="Create credentials">
    ...
    <img className="rounded-image" src="/assets/admins/connectors/google_drive/GoogleDriveCredential.png" alt="Creating OAuth client ID in Google Cloud Console" width="90%" />
    ...
    - `http://localhost:3000/admins/connectors/google-drive/auth/callback` if self-hosting
    - `https://<INTERNAL_DEPLOYMENT_URL>/admins/connectors/google-drive/auth/callback` if you have setup Onyx for production use
    - `https://cloud.onyx.app/admins/connectors/google-drive/auth/callback` if you are using the Onyx Cloud service

    <img className="rounded-image" src="/assets/admins/connectors/google_drive/DriveCredentials.png" alt="Configuring authorized origins and redirect URIs for Google Drive OAuth client" width="70%" />
    ...
    <img className="rounded-image" src="/assets/admins/connectors/google_drive/DriveDownloadCredentials.png" alt="Download OAuth client JSON credentials from Google Cloud Console" width="70%" />
  </Step>
</Steps>
