...
<img className="rounded-image" src="/assets/admins/connectors/clickup/ClickUp_Hierarchy.gif" alt="ClickUp workspace hierarchy illustrating spaces, folders, and lists"/>
...
<Steps>
  ...
  <Step title="Generate API token">
    ...
    <img className="rounded-image" src="/assets/admins/connectors/clickup/ClickupToken.png" alt="Clickup token generation"/>
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Enter API token and Team ID">
    ...
    <img className="rounded-image" src="/assets/admins/connectors/clickup/ClickupAuth.png" alt="Clickup connector authentication"/>
  </Step>
  ...
  <Step title="Select connector type">
    ...
    * The space id(s), folder id(s), list id(s) could be found in the web url in Clickup.
    ...
    <img className="rounded-image" src="/assets/admins/connectors/clickup/ClickupListid.png" alt="Clickup list id"/>
  </Step>
