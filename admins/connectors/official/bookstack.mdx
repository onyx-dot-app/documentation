...
<Steps>
  ...
  <Step title="Open API Tokens">
    ...
    <img className="rounded-image" src="/assets/admins/connectors/bookstack/BookstackApiTokenList.png" alt="BookStack API Tokens List View"/>
  </Step>
  ...
  <Step title="Create and copy token">
    ...
    <img className="rounded-image" src="/assets/admins/connectors/bookstack/BookstackApiToken.png" alt="BookStack API Token View"/>
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Enter URL and tokens">
    ...
    <img className="rounded-image" src="/assets/admins/connectors/bookstack/BookstackAuth.png" alt="BookStack connector step 1 view"/>
  </Step>

  <Step title="Start indexing">
    Click the `Connect` button! Your content will then be pulled into Onyx every **10** minutes.

    <img className="rounded-image" src="/assets/admins/connectors/bookstack/BookstackIndex.png" alt="BookStack connector step 2 view"/>
  </Step>
</Steps>
