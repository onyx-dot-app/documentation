...
<img className="rounded-image" src="/assets/admins/connectors/notion/NotionCreateIntegration.gif" alt="Creating a Notion internal integration in the Notion settings"/>
...
<img className="rounded-image" src="/assets/admins/connectors/notion/NotionAddConnector.png" alt="Adding the Onyx integration to a Notion workspace or page"/>
...
<Steps>
  ...
  <Step title="Enter Integration Token">
    ...
    <img className="rounded-image" src="/assets/admins/connectors/notion/NotionAuth.png" alt="Onyx Notion connector authentication step to connect integration"/>
  </Step>

  <Step title="Connect and index">
    Click the `Connect` button! Your content will then be pulled into Onyx every **10** minutes.

    <img className="rounded-image" src="/assets/admins/connectors/notion/NotionIndex.png" alt="Onyx Notion connector indexing options and selection screen"/>
  </Step>
</Steps>
