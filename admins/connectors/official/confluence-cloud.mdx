...
<Steps>
  <Step title="Open Atlassian account security">
    ...
    ![The Atlassian API Tokens page shows separate buttons for standard and scoped
    tokens](/assets/admins/connectors/confluence/atlassian-api-tokens.jpg)
  </Step>
  ...
  <Step title="Grant scoped-token access">
    ...
    ![Atlassian's Confluence scope picker filtered to read
    scopes](/assets/admins/connectors/confluence/atlassian-scopes.jpg)
...
token](/assets/admins/connectors/confluence/connector-form-cloud.jpg)
