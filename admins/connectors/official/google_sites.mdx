...
Export your Google Site using [Google Takeout](https://takeout.google.com/), and then upload the zip to Onyx.
...
<img className="rounded-image" src="/assets/admins/connectors/google_sites/GoogleSites.png" alt="Onyx Google Sites connector configuration UI"/>
