...
Then, click **Create New**. Under **Option 1: OAuth app**, upload (or paste) the OAuth app JSON you downloaded above,
then click **Authenticate with Gmail**, then continue with the account you want to use to index Gmail.
...
<Note>
  ...
  An instance can hold multiple Gmail credentials.
</Note>
