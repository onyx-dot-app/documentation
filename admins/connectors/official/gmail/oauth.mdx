...
<Steps>
  ...
  <Step title="Create OAuth credentials">
    ...
    - `http://localhost:3000/admins/connectors/gmail/auth/callback` if self-hosting
    - `https://<INTERNAL_DEPLOYMENT_URL>/admins/connectors/gmail/auth/callback` if you have setup Onyx for production use
    - `https://cloud.onyx.app/admins/connectors/gmail/auth/callback` if you are using the Onyx Cloud service
