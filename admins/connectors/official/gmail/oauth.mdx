...
you downloaded above, then click **Authenticate with Gmail**, then continue with the account
...
<Note>
  ...
  instead of creating a new one. An instance can hold multiple Gmail credentials.
</Note>
