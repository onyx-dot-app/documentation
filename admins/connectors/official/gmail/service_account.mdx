...
<Steps>
  ...
  <Step title="Grant domain-wide delegation">
    ...
    `https://www.googleapis.com/auth/gmail.readonly,https://www.googleapis.com/auth/admins.directory.group.readonly,https://www.googleapis.com/auth/admins.directory.user.readonly`
  </Step>
</Steps>
