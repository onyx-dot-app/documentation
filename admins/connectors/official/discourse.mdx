...
<Steps>
  ...
  <Step title="Open API keys">
    ...
    <img className="rounded-image" src="/assets/admins/connectors/discourse/discourse_1.gif" width="400" height="auto" alt="Discourse admin navigation to the API keys page" />
  </Step>

  <Step title="Create API key">
    Click **New API Key**, name it "Onyx". Select "All Users" for **User Level** and "Read-only" for **Scope**.

    <img className="rounded-image" src="/assets/admins/connectors/discourse/discourse_2.gif" alt="Create and fill out API key" />
  </Step>

  <Step title="Save and copy key">
    Click **Save**. Copy the key and put it into Onyx.

    <img className="rounded-image" src="/assets/admins/connectors/discourse/discourse_3.gif" alt="Create and copy API key" />
  </Step>
...
<Steps>
  ...
  <Step title="Provide base URL">
    ...
    <img className="rounded-image" src="/assets/admins/connectors/discourse/discourse_4.gif" alt="Fill out Onyx connector" />
  </Step>
