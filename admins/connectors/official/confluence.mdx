...
<Steps>
  <Step title="Add the credential">
    ...
    ![Confluence credential form](/assets/admins/connectors/confluence/credential-form.jpg)
  </Step>
  ...
  <Step title="Set the deployment and URL">
    ...
    ![Confluence Cloud connector settings](/assets/admins/connectors/confluence/connector-form-cloud.jpg)
  </Step>
