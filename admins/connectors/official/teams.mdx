...
A meeting chat is asked what changed for three days after its last message.
An edit or a delete in a chat that has been quiet for longer is picked up at the next re-index. Pruning removes threads,
