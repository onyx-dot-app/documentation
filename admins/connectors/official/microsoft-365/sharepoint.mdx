...
description: "Index files and pages from the SharePoint sites in your Microsoft 365 tenant, and the files in OneDrive"
---
...
| Limit             | Value                       | Notes                                                                                                                                                       |
| ----------------- | --------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| File size         | 20 MB                       | Onyx skips larger files rather than indexing part of them. Self-hosted deployments can raise this limit with `MICROSOFT_CONNECTOR_SIZE_THRESHOLD` (bytes), which the SharePoint, Teams and Outlook connectors share, or with `SHAREPOINT_CONNECTOR_SIZE_THRESHOLD` for SharePoint alone. |
