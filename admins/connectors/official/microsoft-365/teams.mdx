...
Set `MICROSOFT_CONNECTOR_SIZE_THRESHOLD` (bytes) to change the 20 MB (20 × 1024 × 1024 bytes) size limit for the SharePoint, Teams and Outlook connectors together, or `TEAMS_CONNECTOR_ATTACHMENT_SIZE_THRESHOLD` to change it for Teams alone.
