...
| Permissions | Not available. A crawled page has no per-user access list, so the connector offers **Public** and **Private** only.                                                           |
...
<Steps>
  ...
  <Step title="Enter the base URL">
    In **Base URL**, enter the address to start from, for example `https://docs.onyx.app/`. If you leave off the scheme,
    Onyx adds `https://`.
  </Step>
