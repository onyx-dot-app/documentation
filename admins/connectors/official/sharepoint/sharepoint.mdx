...
<Steps>
  ...
  <Step title="Specify SharePoint configuration">
    ...
    - **Sites**: Select a list of sites to pull from or leave blank to pull everything (Note: this option only works for English, Spanish, and German Sharepoint instances. Contact us if you require further language support)
