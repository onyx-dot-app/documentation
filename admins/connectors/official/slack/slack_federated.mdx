...
We strongly recommend going that direction if it's an option for better search quality until the [Assistant
Search](https://docs.slack.dev/reference/methods/assistant.search.info/) API is publically released.
