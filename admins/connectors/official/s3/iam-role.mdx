...
<Steps>
  <Step title="Create the S3 Access Role">
   ...
   ```
    ...
    <img className="rounded-image" src="/assets/admins/connectors/blob/s3/role-arn.png" alt="Diagram of page where role arn can be copied"/>
  </Step>
  ...
  <Step title="Grant AssumeRole to EC2 instance role">
   ...
   ```
    ...
    <img className="rounded-image" src="/assets/admins/connectors/blob/s3/iam-role.png" alt="Diagram of IAM role assignment"/>
...
<img className="rounded-image" src="/assets/admins/connectors/blob/s3/onyx-iam-role.png" alt="Screenshot of Onyx S3 IAM role configuration with tabs"/>
