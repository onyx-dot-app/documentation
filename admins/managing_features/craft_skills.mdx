...
<Note>
  Anyone can upload a Skill and manage the Skills they own or can edit.
  A **Group Manager** can also manage Skills shared with the groups they manage.
...
Admins and Group Managers create Skills through the same personal creation flow as other users.
...
<Note>
  Sharing a Skill with the whole organization requires being its author or an Admin.
  You can delete any Skill you own or can edit, and Admins can delete any custom Skill.
</Note>
