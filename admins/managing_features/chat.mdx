...
<Info>
  Stricter limits reduce latency, memory use, and token cost.
</Info>
...
**Connectors** and **Actions & Tools** on this page apply to the default chat experience. For agent-first mode, configure knowledge and tools on each [agent](/admins/agents/overview) instead.
