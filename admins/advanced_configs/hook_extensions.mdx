...
icon: "/assets/icons/share_webhook.svg"
---

<Note>
  Hook Extensions are an [Enterprise Edition](/deployment/miscellaneous/enterprise_edition) feature.
</Note>

<Note>
  Hook Extensions are only available on single-tenant deployments.
</Note>
