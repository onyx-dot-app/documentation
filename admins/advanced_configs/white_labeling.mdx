...
<img className="rounded-image" src="/assets/admins/advanced_configs/whitelabeling_overview.png" alt="White Labeling Overview"/>
...
<img className="rounded-image" src="/assets/admins/advanced_configs/whitelabeling_advanced.png" alt="White Labeling Headers and Popups"/>

### Footer

Below the Consent Screen toggle, you can add content to the footer of the Onyx interface.

<img className="rounded-image" src="/assets/admins/advanced_configs/whitelabeling_footer.png" alt="White Labeling Footer"/>
