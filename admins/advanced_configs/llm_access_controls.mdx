---
title: "Language Model Access Controls"
description: "Configure access controls for language model providers"
icon: "lock"
---
...
<img className="rounded-image" src="/assets/admins/advanced_configs/llm_access_controls.png" alt="Language model access controls"/>
