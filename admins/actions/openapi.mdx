...
<Steps>
  <Step title="Navigate to the Actions Dashboard">
    ...
    <img className="rounded-image" src="/assets/admins/actions/admin_panel_openapi.png" alt="OpenAPI Actions tab in Onyx Admin Panel sidebar" style={{ flex: '0 0 18%', minWidth: 0, objectFit: 'contain' }}/>

    <img className="rounded-image" src="/assets/admins/actions/openapi_dashboard.png" alt="OpenAPI Actions dashboard in Onyx Admin Panel" style={{ flex: '1 1 0%', minWidth: 0, objectFit: 'contain' }}/>
  ...
  <Step title="Add an OpenAPI Action">
    ...
    <img className="rounded-image" src="/assets/admins/actions/openapi_modal.png" alt="Add OpenAPI Action modal in Onyx Admin Panel"/>
  </Step>
</Steps>
