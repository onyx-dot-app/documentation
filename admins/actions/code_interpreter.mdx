...
No configuration is required. The code interpreter is a built-in action available to all Onyx deployments out of the box.
...
The code interpreter server is connected by default. You can disconnect or reconnect it at any time from the **Admin Panel**. This page also displays the server's health and connection status.
