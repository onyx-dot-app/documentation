...
<img className="rounded-image" src="/assets/admins/slackbot/slackbot_response.png" alt="Onyx Slack Bot"/>
...
<Steps>
  ...
  <Step title="Generate an App Token">
    ...
    <img className="rounded-image" src="/assets/admins/slackbot/slackbot_app_token.png" alt="Onyx Slack Bot App Token"/>
  </Step>
  ...
  <Step title="Install the Slack App">
    ...
    <img className="rounded-image" src="/assets/admins/slackbot/slackbot_bot_token.png" alt="Onyx Slack Bot Bot Token"/>
  </Step>
  ...
  <Step title="Setup Onyx for the Slack Bot">
    ...
    <img className="rounded-image" src="/assets/admins/slackbot/slackbot_onyx_setup.png" alt="Onyx Slack Bot Onyx Setup"/>
  </Step>
  ...
  <Step title="Configure the Slack Bot's Behavior">
    ...
    <img className="rounded-image" src="/assets/admins/slackbot/slackbot_config.png" alt="Onyx Slack Bot Configuration"/>
  </Step>
</Steps>
