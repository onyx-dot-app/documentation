...
<img className="rounded-image" src="/assets/admins/ai_models/ai_config_overview.png" alt="AI Configuration Overview"/>
...
<AccordionGroup>
  ...
  <Accordion title="Self-Hosted Providers" icon="server">
    ...
    Self-hosted models are open-weight and available for free download, such as Meta's Llama models, DeepSeek, and Qwen.

    Onyx supports any OpenAI-compatible gateway or inference server, like [Ollama](/admins/ai_models/ollama)
    and [LM Studio](/admins/ai_models/lm_studio).
  </Accordion>
</AccordionGroup>
