...
<Steps>
  <Step title="Setup LM Studio and Load Your Models">
    ...
    <Info>
      **Running Onyx in Docker on the same machine as LM Studio?**
      ...
      By default, LM Studio binds only to `127.0.0.1`, which is unreachable from inside an Onyx container. To fix:
  ...
  <Step title="Configure LM Studio">
    ...
    If Onyx is running in Docker on the same machine as LM Studio,
