...
<Steps>
  ...
  <Step title="Set the new count">
    ...
    <Note>
      Need to reduce seats below current usage?
      [Remove users](/admins/user_management/users_and_groups) first, then adjust the seat count.
    </Note>
  </Step>
...
For self-hosted deployments without internet access, you can activate a license manually
...
To update an existing license (e.g., after renewal or a seat change), click **Update License Key** instead
