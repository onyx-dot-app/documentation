...
<img className="rounded-image" src="/assets/admins/agents/agents_overview.png" alt="Onyx Agents Overview page showing available agents" />
...
<Steps>
  ...
  <Step title="Basic Agent Configuration">
    ...
    <img className="rounded-image" src="/assets/admins/agents/agent_instructions.png" alt="Onyx Agent Configuration page" />
  </Step>
  ...
  <Step title="Access and Sharing">
    ...
    <img className="rounded-image" src="/assets/admins/agents/agent_configs_misc.png" alt="Onyx Agent Configuration page" />
  ...
  <Step title="Advanced Options">
    ...
    <img className="rounded-image" src="/assets/admins/agents/agent_knowledge_options.png" alt="Onyx Agent Configuration page" />
  </Step>
</Steps>
