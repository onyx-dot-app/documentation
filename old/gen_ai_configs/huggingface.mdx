...
![HFSettings](/assets/images/gen_ai/HFSettings.png)

2. Copy the `User Access Token`

![HFAccessToken](/assets/images/gen_ai/HFAccessToken.png)
...
![HFCustomLLMProvider1](/assets/images/gen_ai/HFCustomLLMProvider1.png)

![HFCustomLLMProvider2](/assets/images/gen_ai/HFCustomLLMProvider2.png)
