...
![Cluster creation screen](/assets/images/setup_guides/aws/eks/cluster_create.png)
...
![Adding a node group](/assets/images/setup_guides/aws/eks/add_node_group.png)
...
![Configure group node](/assets/images/setup_guides/aws/eks/configure_group_node.png)
...
![Setting compute and scaling](/assets/images/setup_guides/aws/eks/set_compute_and_scaling.png)
...
![Create user](/assets/images/setup_guides/aws/eks/iam_dashboard.png)
...
![Create access key](/assets/images/setup_guides/aws/eks/create_access_key.png)
...
![EKS access entry](/assets/images/setup_guides/aws/eks/eks_access_entry.png)

In the `IAM principal` select the IAM ARN that you just created. Then click next.

![EKS IAM ARN](/assets/images/setup_guides/aws/eks/eks_iam_arn.png)
...
![EKS policy](/assets/images/setup_guides/aws/eks/eks_policy.png)
