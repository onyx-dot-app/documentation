...
![Instance](/assets/images/setup_guides/aws/Instance.png)

When setting up the security group for the new instance, make sure that you allow for HTTPS traffic.

![Instance](/assets/images/setup_guides/aws/InstanceNetworking.png)
...
![Instance](/assets/images/setup_guides/aws/InstanceIp.png)

Finally, we need to head to the DNS provider and add two entries into the DNS:

![Instance](/assets/images/setup_guides/aws/ARecord.png)
![Instance](/assets/images/setup_guides/aws/CnameRecord.png)
