...
![Assistant Configuration Interface](/assets/images/guides/assistants/setup.png)
...
5. **Search Tool and Actions**: Additional capabilities that the assistant can perform (see [Actions](../../admin/actions/overview))
...
![Assistant Configuration Interface](/assets/images/guides/assistants/advanced_config.png)
