...
![Connector ID](/assets/images/more/FindingCCPairId.png)
...
If you are trying to use any Onyx endpoint that requires authorization, such as the [Answer with Quote](../developer/apis/answer_with_quote) endpoint,
