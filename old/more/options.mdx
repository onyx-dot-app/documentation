...
![Connectors page](/assets/images/more/connectors.png)

2. Click on the connector you want the ID of .

![Connector ID](/assets/images/more/connectorID.png)
...
![Zoomed in Connector ID](/assets/images/more/zoomConnectorID.png)
...
1. Ensure your Docker containers are running- you can refer to the [quickstart guide](../deployment/quickstart):
