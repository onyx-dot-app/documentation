...
![Instance](/assets/images/setup_guides/do/InstanceIp.png)

Finally, we need to head to the DNS provider and add two entries into the DNS:

![Instance](/assets/images/setup_guides/do/ARecord.png)
![Instance](/assets/images/setup_guides/do/CnameRecord.png)
