...
1. Go to the [Google Cloud Console Dashboard](https://console.cloud.google.com/) to create a VM Instance ![Create VM INstance](/assets/images/setup_guides/gcp/CreateVmInstance.png)
...
3. We recommend at least 16GB of RAM, 4-8vCPU cores, and 500GB of disk. The exact instance type to
   ...
   ![Instance](/assets/images/setup_guides/gcp/Instance.png)
4. Make sure to allow HTTPS traffic in the firewall settings and valid scopes for the instance. ![Firewall](/assets/images/setup_guides/gcp/Firewall.png)
...
![Instance](/assets/images/setup_guides/gcp/InstanceIp.png)

Finally, we need to head to the DNS provider and add two entries into the DNS:

![Instance](/assets/images/setup_guides/gcp/ARecord.png)
![Instance](/assets/images/setup_guides/gcp/CnameRecord.png)
