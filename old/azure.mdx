...
![Create VM Instance](/assets/images/setup_guides/azure/create-vm.png)
...
![Create VM Instance](/assets/images/setup_guides/azure/create-vm-2.png)

4. Make sure to allow HTTPS traffic in the firewall settings and valid scopes for the instance.

![Create VM Instance](/assets/images/setup_guides/azure/create-vm-3.png)
...
![Instance](/assets/images/setup_guides/azure/instance-ip.png)
