...
In additon to the extra features mentioned in the [overview page](./overview), you have access to additional configuraton options in the form of environment variables as an Entprprise Edition user.
