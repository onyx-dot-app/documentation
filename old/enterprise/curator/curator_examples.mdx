...
![Curator Example 1](/assets/images/curator/curator_example_1_scenario.png)

You want to add a connector from the sales team's group to a document set that belongs to the marketing team's group:

![Curator Example 1](/assets/images/curator/curator_example_1_goal.gif)

### How to do it

1. First, the connector needs to be added to the marketing team's group: <br/>
![Curator Example 1](/assets/images/curator/curator_example_1_step_1.gif)
...
![Curator Example 1](/assets/images/curator/curator_example_1_step_2.gif)
...
![Curator Example 1](/assets/images/curator/curator_example_1_alternative_solution.png)
