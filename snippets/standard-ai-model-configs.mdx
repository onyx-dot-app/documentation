<Step title="Configure Default and Fast Models">
    ...
    Designating a **Fast Model** is optional. The **Fast Model** is used behind the scenes for quick operations 
    such as evaluating the type of message, generating different queries (query expansion), and naming the chat session.

    <Tip>
        If you select a **Fast Model**, make sure it is a relatively quick and cost-effective model like GPT-4o-mini, o3-mini, or GPT-5-mini.
    </Tip>
</Step>
