...
<CardGroup cols={2}>
  ...
  <Card title="Group-Based Permissions" icon="users" href="/admins/permissions/understanding_permissions">
    Fine-grained, group-based access control for Connectors, Document Sets, and Agents. Available in v4.7+.
  </Card>
