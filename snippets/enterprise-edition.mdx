...
<CardGroup cols={2}>
  ...
  <Card title="Curator Role" icon="users" href="/admins/curators/overview">
  ...
  <Card title="Hook Extensions" icon="/assets/icons/share_webhook_blue.svg" href="/admins/advanced_configs/hook_extensions">
