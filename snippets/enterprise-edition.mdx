...
<CardGroup cols={2}>
  ...
  <Card title="Permission Sync Connectors" icon="sitemap" href="/admin/connectors/overview#permission-syncing-connectors">
  ...
  <Card title="User Groups & RBACs" icon="users" href="/admin/user_management/users_and_groups">
  ...
  <Card title="Usage Analytics" icon="chart-line" href="/admin/analytics/overview">
