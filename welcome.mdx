...
Onyx is your org's context layer.
It ingests knowledge from connected applications to build an internal representation and makes it available on demand to
your team and their AI agents.

Onyx provides state of the art answer reliability and is the most data private option available. Search for documents,
build tailored AI Agents, research the web, and more - all in one place.
...
<Columns cols={2}>
  ...
  <Card title="Connectors" icon="plug" href="/overview/core_features/connectors">
    Connect your team's applications to make your organization's knowledge searchable in Onyx.
  </Card>
...
<Info>
  To learn about other features, check out the [Core Features](/overview/core_features/internal_search)
