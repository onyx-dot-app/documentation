...
![HighspotEnableDeveloper](/assets/admin/connectors/highspot/highspot_enable_developer.png)
...
#### Generating API Credentials
    ...
    ![HighspotGenerateAPI](/assets/admin/connectors/highspot/highspot_generate_api.png)
