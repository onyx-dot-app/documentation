...
![SlackApp](/assets/admin/connectors/slack/SlackApp.png)
...
![SlackBotToken](/assets/admin/connectors/slack/SlackBotToken.png)
...
![SlackConnectorSetting](/assets/admin/connectors/slack/SlackConnectorSetting.png)

3. Set the **Workspace ID** (see below) and click **Connect**.

![SlackId](/assets/admin/connectors/slack/SlackId.png)
