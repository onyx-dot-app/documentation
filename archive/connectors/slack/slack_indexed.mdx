...
![SlackBotToken](/archive/images/connectors/slack/SlackBotToken.png)
...
![SlackConnectorSetting](/archive/images/connectors/slack/SlackConnectorSetting.png)

3. Set the **Workspace ID** (see below) and click **Connect**.

![SlackId](/archive/images/connectors/slack/SlackId.png)
