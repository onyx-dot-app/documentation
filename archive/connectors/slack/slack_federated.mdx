...
![SlackBotToken](/assets/admin/connectors/slack/FederatedSlackCredentials.png)
...
![SlackConnectorSetting](/assets/admin/connectors/slack/SlackFederatedConnectorSetting.png)
...
![SlackId](/assets/admin/connectors/slack/FederatedSlackOauth.png)
