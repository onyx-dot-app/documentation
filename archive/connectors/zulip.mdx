...
![ZulipBot](/assets/admin/connectors/zulip/ZulipBot.png)

    3. Copy the Bot authentication info (`zuliprc` contents), see red arrow below:

![ZulipRC](/assets/admin/connectors/zulip/ZulipRC.png)
...
![ZulipRealmURL](/assets/admin/connectors/zulip/ZulipRealmURL.png)

    4. In **Step 2**, provide the values for the Realm and URL

![OnyxZulipConfig](/assets/admin/connectors/zulip/OnyxZulipConfig.png)
