...
![ZulipBot](/archive/images/connectors/zulip/ZulipBot.png)

    3. Copy the Bot authentication info (`zuliprc` contents), see red arrow below:

![ZulipRC](/archive/images/connectors/zulip/ZulipRC.png)
...
![ZulipRealmURL](/archive/images/connectors/zulip/ZulipRealmURL.png)

    4. In **Step 2**, provide the values for the Realm and URL

![OnyxZulipConfig](/archive/images/connectors/zulip/OnyxZulipConfig.png)
