...
![FirefliesConnectorAuth](/assets/admin/connectors/fireflies/fireflies1.png)

    3. Select **Developer Settings**.

![FirefliesConnectorAuth](/assets/admin/connectors/fireflies/fireflies2.png)

    4. Copy the **API Key**.

![FirefliesConnectorAuth](/assets/admin/connectors/fireflies/fireflies3.png)
