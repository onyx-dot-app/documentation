...
![IndexStatus](/archive/images/connectors/IndexStatus.png)

## Missing a Connector?

Is there a Connector that would be useful to you?
Let us know via a [GitHub Issues](https://github.com/onyx-dot-app/onyx/issues) page.
...
As Onyx is opensource, one of the best features is that anyone can add to it!
We encourage people who need new connectors to contribute it back to the Onyx repo for other people to benefit as well.
