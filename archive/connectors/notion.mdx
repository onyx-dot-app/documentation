...
![Notion create integration](/assets/admin/connectors/notion/NotionCreateIntegration.gif)
...
![Notion add connection](/assets/admin/connectors/notion/NotionAddConnector.png)
...
![Notion connector step 1 view](/assets/admin/connectors/notion/NotionAuth.png)

    3. Click the `Connect` button! Your content will then be pulled into Onyx every **10** minutes.

![Notion connector step 2 view](/assets/admin/connectors/notion/NotionIndex.png)
