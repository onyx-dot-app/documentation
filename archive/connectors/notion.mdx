...
![Notion create integration](/archive/images/connectors/notion/NotionCreateIntegration.gif)
...
![Notion add connection](/archive/images/connectors/notion/NotionAddConnector.png)
...
![Notion connector step 1 view](/archive/images/connectors/notion/NotionAuth.png)

    3. Click the `Connect` button! Your content will then be pulled into Onyx every **10** minutes.

![Notion connector step 2 view](/archive/images/connectors/notion/NotionIndex.png)
