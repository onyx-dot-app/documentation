...
#### To enable permission syncing for this connector:
    ...
    - The account performing the OAuth flow must have an Admin role in the Google Workspace that has access to the
      "Groups > Read" privilege.
        - This can be set by an admin in the admin panel of the Google Workspace under Account>Admin roles.
    - **Note**: If you are using a Google Workspace, you can also set up a Service Account to access Gmail.
      This is currently in development and will be available soon.

![GmailScopes](/archive/images/connectors/gmail/GmailScopes.png)
...
![GmailCredential](/archive/images/connectors/google_drive/GoogleDriveCredential.png)
...
![GmailScopes](/archive/images/connectors/gmail/GmailCredentials.png)
...
![GmailScopes](/archive/images/connectors/google_drive/DriveDownloadCredentials.png)
