...
If you'd rather use an individuals account + OAuth to access Google Drive,
checkout the section [here](/archive/connectors/google_drive/oauth).
...
![GoogleDriveAdminConsole](/archive/images/connectors/google_drive/ServiceAccountCredential.png)
