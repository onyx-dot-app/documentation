...
![SalesforceConnectorAuth](/assets/admin/connectors/salesforce/salesforce_1.png)

    3. Select **My Personal Information** → **Reset My Security Token**.

![SalesforceConnectorAuth](/assets/admin/connectors/salesforce/salesforce_2.png)

    4. Check your email for the security token.

![SalesforceConnectorAuth](/assets/admin/connectors/salesforce/salesforce_3.png)
...
![SalesforceConnectorAuth](/assets/admin/connectors/salesforce/salesforce_4.png)
...
![SalesforceConnectorAuth](/assets/admin/connectors/salesforce/salesforce_5.png)
