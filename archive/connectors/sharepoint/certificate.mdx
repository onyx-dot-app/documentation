...
you can also use [client secret authentication](/archive/connectors/sharepoint/client-secret).
...
4. Name it something like "Onyx SharePoint Connector - Certificate", leave everything else as default,
   and click **Register**.
...
For basic SharePoint integration without permission sync,
you can use [client secret authentication](/archive/connectors/sharepoint/client-secret).
