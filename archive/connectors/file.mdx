...
### Authorization
    ...
    - [WIP]
      Admins or normal users will be able to upload files via personal connectors and make them accessible for just
      themselves.
...
![FileConnector](/archive/images/connectors/file/FileConnector.png)
