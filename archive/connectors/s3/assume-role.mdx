...
2. Verify the instance profile is properly configured via AWS Console under **EC2 › Instance Settings › Attach/Replace
   IAM role**.
...
![Screenshot of Onyx S3 assume role configuration](/archive/images/connectors/blob/s3/onyx-assume-role.png)
