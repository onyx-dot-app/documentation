---
title: "AWS Access Keys Authorization"
...
![IAM page](/archive/images/connectors/blob/s3/iam.png)
...
12. You should now see, you'll see the Access Key ID and Secret Access Key.
    Make sure to copy these immediately as you won't be able to access the Secret Access Key again.

![AWS Credentials](/archive/images/connectors/blob/s3/accesskeyspage.png)
...
![Onyx S3 page 1](/archive/images/connectors/blob/s3/onyx-access-key.png)

Once you have your AWS Access Keys,
proceed to the [indexing steps in the overview](/archive/connectors/s3/overview#indexing)
