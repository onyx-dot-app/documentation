...
1. **Create the S3 Access Role:**
   ...
   ![Diagram of page where role arn can be copied](/assets/admin/connectors/blob/s3/role-arn.png)
...
![Diagram of IAM role assignment](/assets/admin/connectors/blob/s3/iam-role.png)
...
![Screenshot of Onyx S3 IAM role configuration with tabs](/assets/admin/connectors/blob/s3/onyx-iam-role.png)
