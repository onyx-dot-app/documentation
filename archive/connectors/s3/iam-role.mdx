...
1. **Create the S3 Access Role:**
   ...
   ![Diagram of page where role arn can be copied](/archive/images/connectors/blob/s3/role-arn.png)
...
![Diagram of IAM role assignment](/archive/images/connectors/blob/s3/iam-role.png)
...
![Screenshot of Onyx S3 IAM role configuration with tabs](/archive/images/connectors/blob/s3/onyx-iam-role.png)

Once you have your IAM Role ARN,
