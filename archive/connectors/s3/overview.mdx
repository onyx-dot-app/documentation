...
- [AWS Access Keys](/archive/connectors/s3/access-keys) - Uses traditional access key credentials
- [IAM Role-Based Authorization](/archive/connectors/s3/iam-role) - Uses AWS IAM roles for secure access
- [Assume Role](/archive/connectors/s3/assume-role) - Automatically uses the EC2 instance's attached role for S3 access
...
![Onyx S3 connector details page](/archive/images/connectors/blob/s3/connector.png)
