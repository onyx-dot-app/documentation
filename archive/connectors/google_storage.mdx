...
2. Navigate to "Cloud Storage" > "Settings" > "Interoperability".
   ...
   ![Google Cloud Storage Interoperability](/assets/admin/connectors/blob/google/interoperability.png)
...
4. Click "Create new account" (or select an existing account and click Create key > skip to Step 8).
   ...
   ![New service account](/assets/admin/connectors/blob/google/new_service_account.png)

5. Set a name for the new service account (e.g., "onyx-gcs-connector") and click "Create and continue".

   ![Service account configuration](/assets/admin/connectors/blob/google/service_account_config.png)

6. Click "Select a role" and select Storage object viewer or another, more permissive role.
7. Click "Done".

   ![Service account permissions](/assets/admin/connectors/blob/google/service_account_perms.png)
...
8. You should be back on the Cloud Storage Interoperability page and see the new credentials. Record both `Access key` and `Secret`.
   ...
   ![HMAC keys](/assets/admin/connectors/blob/google/hmac_keys.png)
...
![Onyx Google Cloud Storage credentials](/assets/admin/connectors/blob/google/onyx_1.png)
...
![Onyx Connector creation](/assets/admin/connectors/blob/google/onyx_2.png)
