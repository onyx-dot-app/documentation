...
![GongMenu](/assets/admin/connectors/gong/GongMenu.png) 3. Next, find the **Ecosystem** block and select `API`

![GongEcosystem](/assets/admin/connectors/gong/GongEcosystem.png) 4. Once there,
