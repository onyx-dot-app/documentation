...
<Info>
  ...
  **Why is this required?**
  ...
  Onyx uses the public email to match GitHub users with Onyx users for permission synchronization.
  Without a public email, the system cannot identify which GitHub permissions apply to which Onyx user.
</Info>
...
![GithubConnector](/archive/images/connectors/github/GithubCredential.png)

![GithubConnector](/archive/images/connectors/github/GithubConnector.png)
