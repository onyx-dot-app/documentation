...
![BookStack API Tokens List View](/assets/admin/connectors/bookstack/BookstackApiTokenList.png)
...
![BookStack API Token View](/assets/admin/connectors/bookstack/BookstackApiToken.png)
...
![BookStack connector step 1 view](/assets/admin/connectors/bookstack/BookstackAuth.png)

    3. Click the `Connect` button! Your content will then be pulled into Onyx every **10** minutes.

![BookStack connector step 2 view](/assets/admin/connectors/bookstack/BookstackIndex.png)
