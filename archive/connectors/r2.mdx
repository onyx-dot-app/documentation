...
![Manage API](/archive/images/connectors/blob/r2/manageapi.png)

4. Click "Create API token".

![Create API token](/archive/images/connectors/blob/r2/newtoken.png)

5. Give your token a name (e.g., "OnyxR2Connector") and select the appropriate permissions (Object Read only).

   ![Read only](/archive/images/connectors/blob/r2/readonly.png)

6. Click "Create API Token".
7. On the next screen, you'll see your Access Key ID and Secret Access Key.
   Make sure to copy these immediately as you won't be able to access the Secret Access Key again.

8. To find your Account ID, go to the Overview page in your Cloudflare dashboard.
   The Account ID is listed in the url as the final substring.

![Onyx page 1](/archive/images/connectors/blob/r2/id.png)
...
![Onyx page 2](/archive/images/connectors/blob/r2/Onyx1.png)
...
![Onyx page 2](/archive/images/connectors/blob/r2/Onyx2.png)
