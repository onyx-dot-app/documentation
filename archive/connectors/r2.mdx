...
![Manage API](/assets/admin/connectors/blob/r2/manageapi.png)

4. Click "Create API token".

![Create API token](/assets/admin/connectors/blob/r2/newtoken.png)

5. Give your token a name (e.g., "OnyxR2Connector") and select the appropriate permissions (Object Read only).

   ![Read only](/assets/admin/connectors/blob/r2/readonly.png)
...
![Onyx page 1](/assets/admin/connectors/blob/r2/id.png)
...
![Onyx page 2](/assets/admin/connectors/blob/r2/Onyx1.png)
...
![Onyx page 2](/assets/admin/connectors/blob/r2/Onyx2.png)
