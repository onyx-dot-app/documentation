...
### Indexing
    ...
    >![JiraConnectorAuth](/assets/admin/connectors/jira/JiraCloudAuth.png)

    >#### Server
    >Provide the **Personal Access Token**:
    >![JiraConnectorAuth](/assets/admin/connectors/jira/JiraServerAuth.png)
...
![JiraIndex](/assets/admin/connectors/jira/JiraIndex.png)
