...
### Authorization
    ...
    5. Under “Essentials” in the overview tab, you will find the client ID and Directory ID,
       copy paste those into the onyx connector.
    ...
    14. Navigate to the “ChannelSettings” permission group and select the checkbox for
