...
The term **telemetry** here refers to the collection of _anonymous data_ that is _limited in scope_ and for the purpose
of improving the quality of a piece of software.

This page describes our philosophy towards telemetry,
what kind of data is collected and how to easily opt-out of all data collection.

## Why do we collect telemetry

As a software that uses a combination of deep-learning models and LLMs as well as interfacing with a variety of external
SaaS tools for data collection,
Onyx's performance is strongly dependent on a multitude of factors that we cannot predict.
Telemetry helps us understand how the system is performing in real life situations and allows us to improve specific
