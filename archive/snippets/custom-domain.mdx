<Step title="Point domain to the instance">
    ...
    <img className="rounded-image" src="/archive/assets/deployment/arecord.png" alt="DNS A Record Configuration" />

    <img className="rounded-image" src="/archive/assets/deployment/cname.png" alt="DNS CNAME Record Configuration" />
</Step>
