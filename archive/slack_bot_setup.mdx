...
![SlackBot](/archive/images/slack_bot/SlackBot.png)
...
![SlackBotConfig](/archive/images/slack_bot/SlackBotConfig.png)
...
![SlackApp](/archive/images/connectors/slack/SlackApp.png)
...
8. Under **OAuth Tokens for Your Workspace**, select `Install to Workspace` and Allow the app.
   ...
   ![OnyxBotInstall](/archive/images/slack_bot/OnyxBotInstall.png)
...
![OnyxAdminButton](/archive/images/slack_bot/OnyxAdminButton.png)
...
![SlackBotTokens](/archive/images/slack_bot/SlackBotTokens.png)
