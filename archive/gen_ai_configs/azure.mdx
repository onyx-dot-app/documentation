...
![Azure OpenAI Service](/archive/images/gen_ai/azure/1_azure.png)

2. Click "Create a resource" to begin setup

![Create a resource](/archive/images/gen_ai/azure/2_create.png)

3. Create a new resource group and complete the required form fields

![Create resource group](/archive/images/gen_ai/azure/3_createopenai.png)
...
![Chat panel](/archive/images/gen_ai/azure/4_chatplayground.png)

6. Create a new deployment by selecting a chat completion model

![Create deployment](/archive/images/gen_ai/azure/5_model.png)

![Select model](/archive/images/gen_ai/azure/6_deploy.png)
...
![Validate configuration](/archive/images/gen_ai/azure/7_validate.png)

9. After validation, click "View Code" to access your credentials

![View Code](/archive/images/gen_ai/azure/8_secrets.png)
...
![Credentials](/archive/images/gen_ai/azure/9_version.png)
