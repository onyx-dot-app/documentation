...
![OllamaLLMProvider1](/archive/images/gen_ai/OllamaLLMProvider1.png)

![OllamaLLMProvider2](/archive/images/gen_ai/OllamaLLMProvider2.png)

**Note**: For the API Base, you should point Onyx to wherever Ollama is running.
To point to a Docker container running at http://localhost:11434,
use host.docker.internal instead of localhost (as shown in the screenshots).

You may also want to update some of the environment variables depending on your model choice / how you're running Ollama
(e.g. on CPU vs GPU):
