...
3. Set up a `Custom LLM Provider` in the Admin Panel. See the screenshots below
   for an example of what this should look like. Replace `YOUR_GCP_PROJECT_ID` with your actual GCP project ID.

<div className="flex gap-2">
  <div>![VertexAILLMProvider](/archive/images/gen_ai/vertex_ai/cli-1.png)</div>
  <div>![VertexAILLMProvider](/archive/images/gen_ai/vertex_ai/cli-2.png)</div>
  <div>![VertexAILLMProvider](/archive/images/gen_ai/vertex_ai/cli-3.png)</div>
</div>
...
![VertexAILLMProvider](/archive/images/gen_ai/vertex_ai/service-acc-1.png)
...
![VertexAILLMProvider](/archive/images/gen_ai/vertex_ai/service-acc-2.png)
...
<div>![VertexAILLMProvider](/archive/images/gen_ai/vertex_ai/onyx-service-acc-1.png)</div>
...
<div>![VertexAILLMProvider](/archive/images/gen_ai/vertex_ai/onyx-service-acc-2.png)</div>
