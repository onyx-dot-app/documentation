...
In additon to the extra features mentioned in the [overview page](/archive/enterprise_edition/overview),
...
This endpoint allows you to test the standard answers that would be returned for a given message and set of Slack bot
categories.
...
The response will contain the standard answers that match the provided message and categories,
or an empty list of standard answers if none are found.
...
feel free to message us at founders@onyx.app for clarification or join our
