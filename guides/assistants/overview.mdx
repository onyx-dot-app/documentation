...
![Assistant Configuration Interface](/images/guides/assistants/setup.png)
...
5. **Search Tool and Actions**: Additional capabilities that the assistant can perform (see [Actions](../../actions/overview))
...
![Assistant Configuration Interface](/images/guides/assistants/advanced_config.png)
