...
<Info>
  Coming soon: Full page context chat and indexing visited pages into your Onyx
  knowledge base!
</Info>

<img
  className="rounded-image"
  src="/assets/deployment/onyx_chrome_extension.png"
  alt="Onyx Chrome Extension Home Page"
/>
...
<Note>
  The extension will now connect to your self-hosted Onyx instance and can be
  used from any page in Chrome.
</Note>
...
<Step title="Add the extension">
  ...
  plus icon to add the extension - Enter the Chrome extension ID and click
  **Add**
</Step>
