...
```html
<!-- Load the widget -->
<script type="module" src="https://cdn.onyx.app/widget/v1/onyx-widget.js"></script>

<!-- Configure and display -->
<onyx-chat-widget
  backend-url="https://cloud.onyx.app"
...
```html
<!-- Onyx Cloud -->
<onyx-chat-widget backend-url="https://cloud.onyx.app" ...></onyx-chat-widget>
