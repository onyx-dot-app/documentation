...
- **Authentication** — see [Personal Access Tokens](/developers/personal_access_tokens)
...
4. Paste your Onyx PAT or API key
5. Click **Connect**
...
<CardGroup cols={2}>
  <Card title="Personal Access Tokens" icon="key" href="/developers/personal_access_tokens">
