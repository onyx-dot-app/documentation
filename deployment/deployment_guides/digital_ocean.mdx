...
<Steps>
    <Step title="Create a Droplet">
        ...
        <img className="rounded-image" src="/assets/images/setup_guides/do/CreateDroplet.png" alt="Create Droplet" />
    </Step>
    ...
    <Step title="Create the Droplet">
        ...
        <img className="rounded-image" src="/assets/images/setup_guides/do/InstanceIp.png" alt="Digital Ocean Public IP Address" />
    </Step>
