...
Onyx Enterprise Edition adds security and user management features designed for larger organizations.
...
<CardGroup cols={2}>
  ...
  <Card title="Permission Sync Connectors" icon="sitemap" href="/admin/getting_started/connectors">
  ...
  <Card title="User Groups & RBACs" icon="users" href="/admin/getting_started/overview">
    Organize users and maintain fine-grained RBACs
  </Card>
  <Card title="Curator Role" icon="users" href="/admin/getting_started/overview">
    A role between Admin and Basic users. Curators can publish Connectors, Document Sets, and Agents
  </Card>
  <Card title="Usage Analytics" icon="chart-line" href="/admin/analytics/statistics">
...
If you're unsure whether Enterprise Edition is right for your organization, we're happy to help you choose the right approach.
...
Alternatively, [contact us](/deployment/miscellaneous/contact_us) for a free self-hosted trial.