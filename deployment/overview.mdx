...
It is great for users who want to try Onyx quickly or teams only interested in Chat and Agents.
Includes LLM chat, tools, file uploads, and Projects, but does not include the vector database,
background workers, or model inference servers.
