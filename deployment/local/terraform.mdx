---
title: "Terraform"
description: "Provision the AWS infrastructure Onyx runs on with Terraform modules"
icon: "grid"
---
...
<Note>
  This page covers the Terraform **modules** that provision the infrastructure Onyx runs on — VPC, EKS, RDS,
  and the rest. They run before Onyx exists.
