...
<Tip>
  To deploy Onyx on AKS with managed PostgreSQL, Redis, and Blob Storage,
  use the [Terraform modules](/deployment/local/terraform) for Azure.
</Tip>
...
<Steps>
  <Step title="Create a VM instance">
    ...
    <img className="rounded-image" src="/assets/deployment/setup_guides/azure/create-vm.png" alt="Create VM Instance"/>

    <img className="rounded-image" src="/assets/deployment/setup_guides/azure/create-vm-2.png" alt="Instance Settings"/>

    <img className="rounded-image" src="/assets/deployment/setup_guides/azure/create-vm-3.png" alt="Network Settings"/>
  </Step>
  ...
  <Step title="Create the instance">
    ...
    <img className="rounded-image" src="/assets/deployment/setup_guides/azure/instance-ip.png" alt="Azure Public IP Address"/>
  </Step>
