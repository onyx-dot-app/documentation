...
## Installation Script
The install script requires `Bash` to run so it works out of the box for Linux and MacOS.
To run Onyx on Windows, install Bash or refer to the [Docker](/deployment/local/docker) deployment.
