...
<Info>Often old, unused Docker images take up sizeable disk space. To clean up unused images, run `docker system prune --all`.</Info>
...
<Info>
  The `vespa` recommendation is the bare minimum for a production deployment. With 50GB of documents,
...
<CardGroup cols={2}>
  <Card title="Guide: Deploy Onyx Locally" icon="microchip" href="/deployment/cloud/local_deployments/docker">
