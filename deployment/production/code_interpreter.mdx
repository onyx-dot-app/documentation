...
The Onyx chart pins the Code Interpreter chart version. Onyx chart 0.8.34 pins Code Interpreter chart **0.4.7**.
You cannot change a subchart version with values.

<Note>
  Sections and keys marked **0.4.8** need Code Interpreter chart 0.4.8 or later. Until the Onyx chart pins 0.4.8,
  install the Code Interpreter chart directly to use them. Code Interpreter 0.4.7 ignores these settings.
</Note>
