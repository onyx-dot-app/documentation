...
check out [Data Flows](/security/architecture/data_flows) and [Data Storage](/security/architecture/data_storage)*

### Complete Data Isolation

All data processing occurs within your infrastructure, ensuring complete control over your data.
No sensitive data leaves your network except for the specific communications you configure.
...
- **LLM Integration**: Bring your own LLM - no data sent to external services unless explicitly
  configured
...
- **Connector Data**: Document content and metadata updates get pulled in from configured external
  applications
- **Model Downloads**: If you configure a non-default embedding or reranking model, it will need to
  be downloaded over the network (it still runs locally).
- **User Interactions**: Chat messages and actions taken in the UI.
- **User Uploads**: Documents uploaded in the Chat interface by the user get processed and stored
  locally.
