...
If additional context is needed, the system can choose between available options including: ingested knowledge, web search (if configured), build in actions (like code interpreter), or additional user configured actions.
