...
If you are trying to use any Onyx endpoint that requires authorization, such as the [Simple Send Message](/developers/api_reference/chat/send_message_simple) endpoint,
