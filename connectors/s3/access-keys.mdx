...
![Onyx S3 page 1](/images/connectors/blob/s3/onyx-access-key.png)

Once you have your AWS Access Keys, proceed to the [indexing steps in the overview](/connectors/s3/overview#indexing) to configure your S3 connector.
