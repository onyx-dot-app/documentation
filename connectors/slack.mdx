---
title: Slack Connector (deprecated)
...
We will be releasing a new connector that uses the Slack real-time search API. Until then, we apologize for any inconvenience this may cause.
