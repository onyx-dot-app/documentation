...
<AccordionGroup>
  <Accordion title="DocumentBase" icon="page">
    ...
    Note that the embeddings are stored in OpenSearch separately.
...
<CardGroup cols={2}>
  {/* <Card title="Guide:
  Create a Connector with the API" icon="lightbulb" href="/developers/guides/create_connector"> Learn how to create a
  ...
  {/* <Card title="Guide:
  Set up an MCP (Admin Panel)" icon="comment" href="/developers/guides/mcp_guide"> Learn how to set up an MCP server in
  the Admin Panel
  </Card> */}
</CardGroup>
