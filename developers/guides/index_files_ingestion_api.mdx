...
<Steps>
  ...
  <Step title="Prepare your request">
    <CodeGroup>
      ...
      API_BASE_URL = "https://cloud.onyx.app/api/onyx-api/ingestion" # or your own domain
      ...
      API_BASE_URL="https://cloud.onyx.app/api/onyx-api/ingestion"
      API_KEY="YOUR_KEY_HERE"
      ```
    </CodeGroup>
  </Step>
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default="http://localhost:8080/api/onyx-api/ingestion"
    )
    parser.add_argument(
        "--headers",
        type=str,
