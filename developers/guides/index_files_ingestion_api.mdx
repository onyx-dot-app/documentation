...
<Tip>
  The ingestion API is a lightweight way to index documents. If you need more control, consider creating a Connector in the Admin Dashboard or following the [Create a Connector](/developers/guides/create_connector) API guide.
</Tip>
...
<Steps>
  ...
  <Step title="Prepare your request">
    <CodeGroup>
        ...
        API_BASE_URL="https://cloud.onyx.app/onyx-api/ingestion"
        API_KEY="YOUR_KEY_HERE"
        ```
    </CodeGroup>
  </Step>
  ...
  <Step title="Make the request to the /ingestion endpoint">
    <CodeGroup>
        ...
        ```bash cURL
        curl --location "${API_BASE_URL}/ingestion" \
