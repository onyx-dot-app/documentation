...
<Tip>
  The ingestion API is a lightweight way to index documents. If you need more control, consider creating a Connector in the Admin Panel or following the [Create a Connector](/developers/guides/create_connector) API guide.
</Tip>
