...
**You will need an API key that can manage connectors.** Its service account must be in the Admin group,
or in a group granting **Manage Connectors & Document Sets**.
Every request in this guide is gated on `manage:connectors`.
