...
is a standardized protocol that enables AI agents to interact with tools and services in a consistent way.
MCP actions in Onyx allow you to connect your agent to development tools, databases,
and other systems that support the MCP protocol.
