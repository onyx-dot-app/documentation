...
<AccordionGroup>
  ...
  <Accordion title="MAX_THREAD_CONTEXT_PERCENTAGE">
    ...
    This is an internal constant derived from model context limits (not configurable via env).

    Current value: `512 * 2 / 3072` ≈ `0.333`
  </Accordion>
