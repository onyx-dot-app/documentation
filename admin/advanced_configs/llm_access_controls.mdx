...
<img className="rounded-image" src="/assets/admin/advanced_configs/llm_access_controls.png" alt="LLM Access Controls" />
...
1. Navigate to **Admin Panel → Configuration → LLM**
2. Click on an existing provider or create a new one
3. In the **Access Controls** section nested under Advanced options:
...
Restricted providers are completely hidden from users who don't have access, preventing confusion and unauthorized usage attempts.
