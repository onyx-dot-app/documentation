...
<Steps>
  ...
  <Step title="Featured Placement">
    Request Featured status to promote your Agent organization-wide.
    Featured Agents appear at the top of the Agents explorer.
  ...
  <Step title="User Training">
    Provide clear starter messages and comprehensive descriptions to guide users in effectively interacting with your
    Agents.
  </Step>
</Steps>
