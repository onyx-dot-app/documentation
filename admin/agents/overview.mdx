...
Agents in Onyx are specialized AI agents that can be configured with custom knowledge bases, system prompts,
and tools to serve specific roles within your organization.
...
<Steps>
  <Step title="Open Agents in Admin Panel">
...
<img className="rounded-image" src="/assets/images/guides/assistants/setup.png" alt="Agent Configuration Interface" />
...
<img className="rounded-image" src="/assets/images/guides/assistants/advanced_config.png" alt="Agent Configuration Interface" />
...
Agents are powerful tools for scaling knowledge access and support within your organization.
Proper configuration and management ensure they provide maximum value while maintaining security and accuracy.
