...
import BuiltInAgentsTable from '/snippets/built-in-agents-table.mdx';
...
From this page, you can create new Agents, edit existing configs, designate featured Agents, hide or show certain Agents, and delete them.
...
<Steps>
  <Step title="Create a New Agent">
    Navigate to the **Admin Panel** and click **Agents** in the sidebar.
  ...
  <Step title="Configure your Agent">
    Add Actions to your Agent to enable it to perform specific tasks. 
    See [Actions Overview](/admin/actions/overview) for more information.
