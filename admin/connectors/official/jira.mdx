...
<Steps>
  ...
  <Step title="Provide credentials">
    ...
    <img className="rounded-image" src="/assets/images/connectors/jira/JiraCloudAuth.png" alt="Onyx Jira Cloud connector authentication form" />

    For Server, provide the **Personal Access Token**:

    <img className="rounded-image" src="/assets/images/connectors/jira/JiraServerAuth.png" alt="Onyx Jira Server connector personal access token form" />
  </Step>
  ...
  <Step title="Choose projects and filters">
    ...
    <img className="rounded-image" src="/assets/images/connectors/jira/JiraIndex.png" alt="Jira indexing configuration showing project URLs and excluded commenters" />
  </Step>
