...
<Steps>
  ...
  <Step title="Open Company Settings">
    ...
    <img className="rounded-image" src="/assets/admin/connectors/gong/GongMenu.png" alt="Gong menu" />
  </Step>

  <Step title="Open Ecosystem → API">
    Next, find the **Ecosystem** block and select `API`

    <img className="rounded-image" src="/assets/admin/connectors/gong/GongEcosystem.png" alt="Gong ecosystem" />
  </Step>
