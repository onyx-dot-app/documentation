...
![GongMenu](/assets/images/connectors/gong/GongMenu.png) 3. Next, find the **Ecosystem** block and select `API`
![GongEcosystem](/assets/images/connectors/gong/GongEcosystem.png) 4. Once there, select `API KEYS` (it's right next to `INTEGRATIONS`) 5. Click on `GET API KEY` and note down the ACCESS KEY and ACCESS KEY SECRET

### Indexing

    1. In the Onyx UI, navigate to the Admin Panel and select the **Gong** Connector
