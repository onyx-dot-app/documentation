...
<Steps>
  <Step title="Open Interoperability settings">
    ...
    <img className="rounded-image" src="/assets/admin/connectors/blob/google/interoperability.png" alt="Google Cloud Storage Interoperability" />
  </Step>
  ...
  <Step title="Create service account key">
    ...
    <img className="rounded-image" src="/assets/admin/connectors/blob/google/new_service_account.png" alt="New service account" />
  </Step>
  ...
  <Step title="Set service account details">
    ...
    <img className="rounded-image" src="/assets/admin/connectors/blob/google/service_account_config.png" alt="Service account configuration" />
  </Step>
  ...
  <Step title="Assign role and finish">
    ...
    <img className="rounded-image" src="/assets/admin/connectors/blob/google/service_account_perms.png" alt="Service account permissions" />
  </Step>
  ...
  <Step title="Record HMAC keys">
    ...
    <img className="rounded-image" src="/assets/admin/connectors/blob/google/hmac_keys.png" alt="HMAC keys" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Create credentials">
    ...
    <img className="rounded-image" src="/assets/admin/connectors/blob/google/onyx_1.png" alt="Onyx Google Cloud Storage credentials" />
  </Step>
  ...
  <Step title="Enter keys and connect">
    ...
    <img className="rounded-image" src="/assets/admin/connectors/blob/google/onyx_2.png" alt="Onyx Connector creation" />
  </Step>
</Steps>
