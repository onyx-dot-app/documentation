...
<Steps>
  ...
  <Step title="Open API keys">
    ...
    <img src="/assets/images/connectors/discourse/discourse_1.gif" width="400" height="auto" alt="Discourse admin navigation to the API keys page" title="NavigateToAPIKeys" />
  </Step>
