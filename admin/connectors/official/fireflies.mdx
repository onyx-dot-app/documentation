...
<Steps>
  ...
  <Step title="Open Developer Settings">
    ...
    <img className="rounded-image" src="/assets/admin/connectors/fireflies/fireflies2.png" alt="FirefliesConnectorAuth" />
  </Step>

  <Step title="Copy API Key">
    Copy the **API Key**.

    <img className="rounded-image" src="/assets/admin/connectors/fireflies/fireflies3.png" alt="FirefliesConnectorAuth" />
  </Step>
