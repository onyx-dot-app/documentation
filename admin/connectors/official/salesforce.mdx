...
<Steps>
  ...
  <Step title="Open Settings">
    ...
    <img className="rounded-image" src="/assets/admin/connectors/salesforce/salesforce_1.png" alt="Salesforce user menu showing path to Settings" />
  </Step>

  <Step title="Reset security token">
    Select **My Personal Information** → **Reset My Security Token**.

    <img className="rounded-image" src="/assets/admin/connectors/salesforce/salesforce_2.png" alt="Salesforce settings highlighting Reset My Security Token" />
  </Step>

  <Step title="Check email for token">
    Check your email for the security token.

    <img className="rounded-image" src="/assets/admin/connectors/salesforce/salesforce_3.png" alt="Email example showing Salesforce security token message" />
  </Step>
...
<img className="rounded-image" src="/assets/admin/connectors/salesforce/salesforce_4.png" alt="Onyx Salesforce connector example configuration using Account object" />
...
<img className="rounded-image" src="/assets/admin/connectors/salesforce/salesforce_5.png" alt="Onyx Salesforce connector advanced JSON configuration for Account and Contact objects" />
