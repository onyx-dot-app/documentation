...
<Steps>
  ...
  <Step title="Open Settings">
    ...
    <img className="rounded-image" src="/assets/images/connectors/salesforce/salesforce_1.png" alt="SalesforceConnectorAuth" />
  </Step>

  <Step title="Reset security token">
    Select **My Personal Information** → **Reset My Security Token**.

    <img className="rounded-image" src="/assets/images/connectors/salesforce/salesforce_2.png" alt="SalesforceConnectorAuth" />
  </Step>

  <Step title="Check email for token">
    Check your email for the security token.

    <img className="rounded-image" src="/assets/images/connectors/salesforce/salesforce_3.png" alt="SalesforceConnectorAuth" />
  </Step>
...
<img className="rounded-image" src="/assets/images/connectors/salesforce/salesforce_4.png" alt="SalesforceConnectorAuth" />
...
<img className="rounded-image" src="/assets/images/connectors/salesforce/salesforce_5.png" alt="SalesforceConnectorAuth" />
