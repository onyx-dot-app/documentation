...
<Steps>
  ...
  <Step title="Create personal access token">
    ...
    <img className="rounded-image" src="/assets/images/connectors/gitlab/GitlabConnectorAuth.gif" alt="GitlabConnectorAuth" />
  </Step>
...
<img className="rounded-image" src="/assets/images/connectors/gitlab/GitlabConnector.png" alt="GitLabConnector" />
