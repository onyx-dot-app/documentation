...
<Steps>
  ...
  <Step title="Create personal access token">
    ...
    <img className="rounded-image" src="/assets/images/connectors/gitlab/GitlabConnectorAuth.gif" alt="Creating a GitLab personal access token with required scopes" />
  </Step>
...
<img className="rounded-image" src="/assets/images/connectors/gitlab/GitlabConnector.png" alt="Onyx GitLab connector project configuration example" />
