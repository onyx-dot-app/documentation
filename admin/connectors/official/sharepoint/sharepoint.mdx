...
- [Client Secret Authentication](/admin/connectors/official/sharepoint/client-secret)
  - Uses traditional client
  secret credentials
- [Certificate-Based Authentication](/admin/connectors/official/sharepoint/certificate)
