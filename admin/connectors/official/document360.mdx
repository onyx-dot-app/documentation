...
<img className="rounded-image" src="/assets/images/connectors/document360/Document360Token.png" alt="Document360 token generation" />
...
<Steps>
  ...
  <Step title="Enter Portal ID and API Key">
    ...
    <img className="rounded-image" src="/assets/images/connectors/document360/Document360Auth.png" alt="Document360 connector authentication with Portal ID and API Key" />
  </Step>
...
<img className="rounded-image" src="/assets/images/connectors/document360/Document360.png" alt="Document360 connector authentication" />
