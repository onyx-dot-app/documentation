...
<img className="rounded-image" src="/assets/images/connectors/notion/NotionCreateIntegration.gif" alt="Notion create integration" />
...
<img className="rounded-image" src="/assets/images/connectors/notion/NotionAddConnector.png" alt="Notion add connection" />
...
<Steps>
  ...
  <Step title="Enter Integration Token">
    ...
    <img className="rounded-image" src="/assets/images/connectors/notion/NotionAuth.png" alt="Notion connector step 1 view" />
  </Step>

  <Step title="Connect and index">
    Click the `Connect` button! Your content will then be pulled into Onyx every **10** minutes.

    <img className="rounded-image" src="/assets/images/connectors/notion/NotionIndex.png" alt="Notion connector step 2 view" />
  </Step>
</Steps>
