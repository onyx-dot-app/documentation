---
title: "Notion"
description: "Access pages and databases from Notion"
---
...
<img className="rounded-image" src="/assets/images/connectors/notion/NotionCreateIntegration.gif" alt="Creating a Notion internal integration in the Notion settings" />
...
<Steps>
  ...
  <Step title="Note about child pages">
    If you've added a page, all child pages also become accesssible to Onyx.
  </Step>
</Steps>

    If you've added a database, all rows (and their children) become accessible to Onyx.

<img className="rounded-image" src="/assets/images/connectors/notion/NotionAddConnector.png" alt="Adding the Onyx integration to a Notion workspace or page" />
...
<Steps>
  ...
  <Step title="Enter Integration Token">
    ...
    <img className="rounded-image" src="/assets/images/connectors/notion/NotionAuth.png" alt="Onyx Notion connector authentication step to connect integration" />
  </Step>

  <Step title="Connect and index">
    Click the `Connect` button! Your content will then be pulled into Onyx every **10** minutes.

    <img className="rounded-image" src="/assets/images/connectors/notion/NotionIndex.png" alt="Onyx Notion connector indexing options and selection screen" />
  </Step>
</Steps>
