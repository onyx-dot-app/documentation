...
<Steps>
  ...
  <Step title="Enable Gmail API and Admin SDK">
    ...
    <img className="rounded-image" src="/assets/images/connectors/google_drive/GoogleDriveEnableAPI.png" alt="Google Cloud Console enabling Gmail and Admin SDK APIs" />
  </Step>
