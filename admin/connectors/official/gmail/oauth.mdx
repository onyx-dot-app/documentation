...
<Steps>
  ...
  <Step title="Set up scopes">
    ...
    <img className="rounded-image" src="/assets/images/connectors/gmail/GmailScopes.png" alt="GmailScopes" />
  </Step>
  ...
  <Step title="Create OAuth credentials">
    ...
    <img className="rounded-image" src="/assets/images/connectors/google_drive/GoogleDriveCredential.png" alt="GmailCredential" />
    ...
    <img className="rounded-image" src="/assets/images/connectors/gmail/GmailCredentials.png" alt="GmailScopes" />
    ...
    <img className="rounded-image" src="/assets/images/connectors/google_drive/DriveDownloadCredentials.png" alt="GmailScopes" />
  </Step>
</Steps>
