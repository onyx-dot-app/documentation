...
<Steps>
  ...
  <Step title="Set up scopes">
    ...
    <Info>
      ...
      "Groups > Read" privilege. This can be set in the Google Admin Console under Account > Admin roles.
      - Note: Service Account support for Gmail is in development and will be available soon.
    </Info>

    ![GmailScopes](/assets/images/connectors/gmail/GmailScopes.png)
  </Step>
  ...
  <Step title="Create OAuth credentials">
    ...
    ![GmailCredential](/assets/images/connectors/google_drive/GoogleDriveCredential.png)
    ...
    ![GmailScopes](/assets/images/connectors/gmail/GmailCredentials.png)
    ...
    ![GmailScopes](/assets/images/connectors/google_drive/DriveDownloadCredentials.png)
  </Step>
</Steps>
