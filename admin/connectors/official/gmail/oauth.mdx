...
<Steps>
  ...
  <Step title="Set up scopes">
    ...
    <img className="rounded-image" src="/assets/images/connectors/gmail/GmailScopes.png" alt="Google Cloud OAuth consent screen with Gmail readonly scope selected" />
  </Step>
  ...
  <Step title="Create OAuth credentials">
    ...
    <img className="rounded-image" src="/assets/images/connectors/google_drive/GoogleDriveCredential.png" alt="Creating OAuth client ID in Google Cloud Console for Gmail" />
    ...
    <img className="rounded-image" src="/assets/images/connectors/gmail/GmailCredentials.png" alt="Authorized origins and redirect URIs for Gmail OAuth client" />
    ...
    <img className="rounded-image" src="/assets/images/connectors/google_drive/DriveDownloadCredentials.png" alt="Download OAuth client JSON credentials from Google Cloud Console" />
  </Step>
</Steps>
