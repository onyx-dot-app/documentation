...
<img className="rounded-image" src="/assets/admin/connectors/github/GithubCredential.png" alt="GithubConnector" />

<img className="rounded-image" src="/assets/admin/connectors/github/GithubConnector.png" alt="GithubConnector" />
