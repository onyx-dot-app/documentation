...
<img className="rounded-image" src="/assets/admin/connectors/github/GithubCredential.png" alt="Onyx GitHub connector credentials entry screen" />

<img className="rounded-image" src="/assets/admin/connectors/github/GithubConnector.png" alt="Onyx GitHub connector repository configuration example" />
