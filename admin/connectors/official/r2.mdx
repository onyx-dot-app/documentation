...
<Steps>
  <Step title="Open R2 dashboard">
    ...
    <img className="rounded-image" src="/assets/images/connectors/blob/r2/manageapi.png" alt="Manage API" />
  </Step>

  <Step title="Create API token">
    Click "Create API token".

    <img className="rounded-image" src="/assets/images/connectors/blob/r2/newtoken.png" alt="Create API token" />
  </Step>

  <Step title="Set permissions">
    Give your token a name (e.g., "OnyxR2Connector") and select the appropriate permissions (Object Read only).

    <img className="rounded-image" src="/assets/images/connectors/blob/r2/readonly.png" alt="Read only" />
  </Step>
  ...
  <Step title="Copy keys and Account ID">
    ...
    <img className="rounded-image" src="/assets/images/connectors/blob/r2/id.png" alt="R2 credentials" />
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Enter credentials">
    ...
    <img className="rounded-image" src="/assets/images/connectors/blob/r2/Onyx1.png" alt="R2 credentials input" />
  </Step>
  ...
  <Step title="Select bucket">
    ...
    <img className="rounded-image" src="/assets/images/connectors/blob/r2/Onyx2.png" alt="R2 bucket selection" />
  </Step>
