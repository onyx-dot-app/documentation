...
<Steps>
  ...
  <Step title="Open profile settings">
    ...
    <img className="rounded-image" src="/assets/admin/connectors/freshdesk/freshdesk_1.png" alt="FreshdeskConnectorAuth" />
  </Step>

  <Step title="View API Key">
    Select **View API Key**.

    <img className="rounded-image" src="/assets/admin/connectors/freshdesk/freshdesk_2.png" alt="FreshdeskConnectorAuth" />
  </Step>
