...
![API Keys](/assets/images/connectors/blob/oci/topbar.png)

3. Under "Resources", click on "Customer Secret Keys".
   ![API Keys](/assets/images/connectors/blob/oci/apikeys.png)
...
![API Keys](/assets/images/connectors/blob/oci/secretkeys.png)
![Hover Key](/assets/images/connectors/blob/oci/hoverkey.png)
...
1. Navigate to the Admin Panel and select the **Oracle Cloud Infrastructure Storage** Connector.
2. In **Step 1**, provide your OCI credentials:

![API Keys](/assets/images/connectors/blob/oci/Onyx1.png)
...
![API Keys](/assets/images/connectors/blob/oci/Onyx2.png)
