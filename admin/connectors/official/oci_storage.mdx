...
<Steps>
  ...
  <Step title="Open User Settings">
    ...
    <img className="rounded-image" src="/assets/images/connectors/blob/oci/topbar.png" alt="OCI user settings" />
  </Step>

  <Step title="Open Customer Secret Keys">
    Under "Resources", click on "Customer Secret Keys".

    <img className="rounded-image" src="/assets/images/connectors/blob/oci/apikeys.png" alt="OCI customer secret keys" />
  </Step>
  ...
  <Step title="Verify keys list">
    ...
    <img className="rounded-image" src="/assets/images/connectors/blob/oci/secretkeys.png" alt="OCI secret keys list" />

    <img className="rounded-image" src="/assets/images/connectors/blob/oci/hoverkey.png" alt="Hover key to view access key" />
  </Step>
...
<Steps>
  ...
  <Step title="Enter OCI credentials">
    ...
    <img className="rounded-image" src="/assets/images/connectors/blob/oci/Onyx1.png" alt="OCI credentials input" />
  ...
  <Step title="Select bucket">
    ...
    <img className="rounded-image" src="/assets/images/connectors/blob/oci/Onyx2.png" alt="OCI bucket selection" />
  </Step>
