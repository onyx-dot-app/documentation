...
<Steps>
  ...
  <Step title="Create user">
    ...
    <img className="rounded-image" src="/assets/images/connectors/blob/s3/iam.png" alt="IAM page" />
  </Step>
  ...
  <Step title="Copy keys">
    ...
    <img className="rounded-image" src="/assets/images/connectors/blob/s3/accesskeyspage.png" alt="AWS Credentials" />
  </Step>
</Steps>
...
<img className="rounded-image" src="/assets/images/connectors/blob/s3/onyx-access-key.png" alt="Onyx S3 page 1" />
