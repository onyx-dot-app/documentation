...
<Steps>
  ...
  <Step title="Create user">
    ...
    <img className="rounded-image" src="/assets/admin/connectors/blob/s3/iam.png" alt="AWS IAM dashboard with Users section for creating a user" />
  </Step>
  ...
  <Step title="Copy keys">
    ...
    <img className="rounded-image" src="/assets/admin/connectors/blob/s3/accesskeyspage.png" alt="AWS security credentials page" />
  </Step>
</Steps>
...
<img className="rounded-image" src="/assets/admin/connectors/blob/s3/onyx-access-key.png" alt="Onyx S3 connector configuration with Access Key ID and Secret fields" />
