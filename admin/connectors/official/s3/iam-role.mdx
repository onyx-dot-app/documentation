...
icon: "cloud"description: "Authorize the S3 connector using an AWS IAM Role with assume role policy."
---
...
1. **Create the S3 Access Role:**
   ...
   ![Diagram of page where role arn can be copied](/assets/images/connectors/blob/s3/role-arn.png)
...
![Diagram of IAM role assignment](/assets/images/connectors/blob/s3/iam-role.png)
...
![Screenshot of Onyx S3 IAM role configuration with tabs](/assets/images/connectors/blob/s3/onyx-iam-role.png)

Once you have your IAM Role ARN, proceed to the [indexing steps in the overview](./overview#indexing) to configure your S3 connector.
