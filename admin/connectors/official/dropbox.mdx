...
<Steps>
  <Step title="Create Dropbox app">
    ...
    ![DropboxStep1](/assets/images/connectors/dropbox/dropbox-connector-1.png)
  </Step>

  <Step title="Open Permissions">
    Click on the `Permissions` tab.

    ![DropboxStep2](/assets/images/connectors/dropbox/dropbox-connector-2.png)
  </Step>
  ...
  <Step title="Grant required scopes">
    ...
    ![DropboxStep3](/assets/images/connectors/dropbox/dropbox-connector-3.png)
  </Step>
  ...
  <Step title="Generate access token">
    ...
    ![DropboxStep4](/assets/images/connectors/dropbox/dropbox-connector-4.png)
  </Step>
  ...
  <Step title="Copy access token">
    ...
    ![DropboxStep5](/assets/images/connectors/dropbox/dropbox-connector-5.png)
  </Step>
</Steps>
