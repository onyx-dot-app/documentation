...
<Steps>
  <Step title="Create Dropbox app">
    ...
    <img className="rounded-image" src="/assets/admin/connectors/dropbox/dropbox-connector-1.png" alt="DropboxStep1" />
  </Step>

  <Step title="Open Permissions">
    Click on the `Permissions` tab.

    <img className="rounded-image" src="/assets/admin/connectors/dropbox/dropbox-connector-2.png" alt="DropboxStep2" />
  </Step>
  ...
  <Step title="Grant required scopes">
    ...
    <img className="rounded-image" src="/assets/admin/connectors/dropbox/dropbox-connector-3.png" alt="DropboxStep3" />
  </Step>
  ...
  <Step title="Generate access token">
    ...
    <img className="rounded-image" src="/assets/admin/connectors/dropbox/dropbox-connector-4.png" alt="DropboxStep4" />
  </Step>
  ...
  <Step title="Copy access token">
    ...
    <img className="rounded-image" src="/assets/admin/connectors/dropbox/dropbox-connector-5.png" alt="DropboxStep5" />
  </Step>
</Steps>
