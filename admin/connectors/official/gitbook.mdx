...
<img className="rounded-image" src="/assets/images/connectors/gitbook/gitbook_1.png" alt="GitBook Developer Page" />
...
<Steps>
  ...
  <Step title="Enter API token">
    ...
    <img className="rounded-image" src="/assets/images/connectors/gitbook/gitbook_2.png" alt="GitBook API Configuration" />
  </Step>
  ...
  <Step title="Enter Space ID and connect">
    ...
    <img className="rounded-image" src="/assets/images/connectors/gitbook/gitbook_3.png" alt="GitBook Space Configuration" />
  </Step>
</Steps>
