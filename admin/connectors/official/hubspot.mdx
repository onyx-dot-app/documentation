...
<Steps>
  <Step title="Create Private App">
    ...
    <img className="rounded-image" src="/assets/admin/connectors/hubspot/HubSpotApp.png" alt="Creating a Private App in HubSpot settings" />
  </Step>
  ...
  <Step title="Select scopes">
    ...
    <img className="rounded-image" src="/assets/admin/connectors/hubspot/HubSpotScope.png" alt="Selecting HubSpot OAuth scopes for Contacts, Companies, Deals, and Tickets" />
  </Step>
