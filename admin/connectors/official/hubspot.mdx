...
<Steps>
  <Step title="Create Private App">
    ...
    <img className="rounded-image" src="/assets/images/connectors/hubspot/HubSpotApp.png" alt="Creating a Private App in HubSpot settings" />
  </Step>
  ...
  <Step title="Select scopes">
    ...
    <img className="rounded-image" src="/assets/images/connectors/hubspot/HubSpotScope.png" alt="Selecting HubSpot OAuth scopes for Contacts, Companies, Deals, and Tickets" />
  </Step>
