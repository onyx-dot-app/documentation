...
<Steps>
  <Step title="Create Private App">
    ...
    <img className="rounded-image" src="/assets/images/connectors/hubspot/HubSpotApp.png" alt="HubSpotApp" />
  </Step>
  ...
  <Step title="Select scopes">
    ...
    <img className="rounded-image" src="/assets/images/connectors/hubspot/HubSpotScope.png" alt="HubSpotScope" />
  </Step>
