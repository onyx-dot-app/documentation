...
<Steps>
  ...
  <Step title="Create a Zulip Bot">
    ...
    <img className="rounded-image" src="/assets/images/connectors/zulip/ZulipBot.png" alt="Creating a bot user in Zulip settings" />
  </Step>

  <Step title="Copy zuliprc contents">
    Copy the Bot authentication info (`zuliprc` contents), see red arrow below:

    <img className="rounded-image" src="/assets/images/connectors/zulip/ZulipRC.png" alt="Zulip bot page highlighting the zuliprc configuration download" />
...
<Steps>
  ...
  <Step title="Get Realm/URL">
    ...
    <img className="rounded-image" src="/assets/images/connectors/zulip/ZulipRealmURL.png" alt="Zulip UI showing Realm and URL details" />
  </Step>

  <Step title="Enter Realm and URL">
    In **Step 2**, provide the values for the Realm and URL

    <img className="rounded-image" src="/assets/images/connectors/zulip/OnyxZulipConfig.png" alt="Onyx Zulip connector configuration with realm, URL, and zuliprc" />
  </Step>
</Steps>
