...
<Steps>
  ...
  <Step title="Create a Zulip Bot">
    ...
    <img className="rounded-image" src="/assets/images/connectors/zulip/ZulipBot.png" alt="ZulipBot" />
  </Step>

  <Step title="Copy zuliprc contents">
    Copy the Bot authentication info (`zuliprc` contents), see red arrow below:

    <img className="rounded-image" src="/assets/images/connectors/zulip/ZulipRC.png" alt="ZulipRC" />
...
<Steps>
  ...
  <Step title="Get Realm/URL">
    ...
    <img className="rounded-image" src="/assets/images/connectors/zulip/ZulipRealmURL.png" alt="ZulipRealmURL" />
  </Step>

  <Step title="Enter Realm and URL">
    In **Step 2**, provide the values for the Realm and URL

    <img className="rounded-image" src="/assets/images/connectors/zulip/OnyxZulipConfig.png" alt="OnyxZulipConfig" />
  </Step>
</Steps>
