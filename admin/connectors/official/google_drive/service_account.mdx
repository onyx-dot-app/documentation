...
<Steps>
  ...
  <Step title="Enable required APIs">
    ...
    <img className="rounded-image" src="/assets/images/connectors/google_drive/GoogleDriveEnableAPI.png" alt="Google Cloud Console enabling Drive, Admin SDK, Docs, and Sheets APIs" />
  </Step>
...
<img className="rounded-image" src="/assets/images/connectors/google_drive/ServiceAccountCredential.png" alt="Onyx Google Drive connector with Service Account credential and Primary Admin Email" />
