...
<Steps>
  ...
  <Step title="Enable Google Docs API">
    ...
    <img className="rounded-image" src="/assets/admin/connectors/google_drive/GoogleDriveEnableAPI.png" alt="Google Cloud Console enabling Google Docs API for the project" />
  </Step>
  ...
  <Step title="Set up scopes">
    ...
    <img className="rounded-image" src="/assets/admin/connectors/google_drive/GoogleDriveScopes.png" alt="OAuth consent screen scopes for Google Drive, Admin SDK, Sheets, and Docs" width="60%" />
  </Step>
  ...
  <Step title="Create credentials">
    ...
    <img className="rounded-image" src="/assets/admin/connectors/google_drive/GoogleDriveCredential.png" alt="Creating OAuth client ID in Google Cloud Console" width="90%" />
    ...
    <img className="rounded-image" src="/assets/admin/connectors/google_drive/DriveCredentials.png" alt="Configuring authorized origins and redirect URIs for Google Drive OAuth client" width="70%" />
    ...
    <img className="rounded-image" src="/assets/admin/connectors/google_drive/DriveDownloadCredentials.png" alt="Download OAuth client JSON credentials from Google Cloud Console" width="70%" />
  </Step>
</Steps>
...
<img className="rounded-image" src="/assets/admin/connectors/google_drive/OAuthCredential.png" alt="Onyx Google Drive connector showing OAuth credential selection" />
