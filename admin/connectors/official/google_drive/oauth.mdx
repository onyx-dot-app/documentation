...
<Steps>
  ...
  <Step title="Enable Google Docs API">
    ...
    ![GoogleDriveEnableAPI](/assets/images/connectors/google_drive/GoogleDriveEnableAPI.png)
  </Step>
  ...
  <Step title="Set up scopes">
    ...
    src="/assets/images/connectors/google_drive/GoogleDriveScopes.png" alt="GoogleDriveScopes" width="60%" />
    </div>
  </Step>
  ...
  <Step title="Create credentials">
    ...
    src="/assets/images/connectors/google_drive/GoogleDriveCredential.png" alt="GoogleDriveScopes" width="90%" />
    </div>
    ...
    src="/assets/images/connectors/google_drive/DriveCredentials.png" alt="GoogleDriveScopes" width="70%" />
    </div>
    ...
    src="/assets/images/connectors/google_drive/DriveDownloadCredentials.png" alt="GoogleDriveScopes" width="70%" />
    </div>
  </Step>
</Steps>
...
![GoogleDriveOAuth](/assets/images/connectors/google_drive/OAuthCredential.png)
