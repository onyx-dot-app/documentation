...
<Steps>
  ...
  <Step title="Create new Slack app">
    ...
    <img className="rounded-image" src="/assets/images/connectors/slack/SlackApp.png" alt="Slack app creation flow with manifest option selected" />
  </Step>
...
<img className="rounded-image" src="/assets/images/connectors/slack/SlackBotToken.png" alt="Slack OAuth & Permissions page showing Bot User OAuth Token" />
...
<Steps>
  ...
  <Step title="Provide credentials">
    ...
    <img className="rounded-image" src="/assets/images/connectors/slack/SlackConnectorSetting.png" alt="Onyx Slack connector settings showing Bot User OAuth Token input" />
  </Step>
...
<img className="rounded-image" src="/assets/images/connectors/slack/SlackId.png" alt="Locating the Slack workspace ID in the app configuration" />
