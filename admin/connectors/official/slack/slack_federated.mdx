...
<img className="rounded-image" src="/assets/images/connectors/slack/FederatedSlackCredentials.png" alt="Slack Basic Information page with Client ID and Client Secret" />
...
<img className="rounded-image" src="/assets/images/connectors/slack/SlackFederatedConnectorSetting.png" alt="Onyx Slack Federated connector settings showing client credentials" />
...
<img className="rounded-image" src="/assets/images/connectors/slack/FederatedSlackOauth.png" alt="Slack OAuth consent screen for Onyx Search Assistant" />
