...
<img className="rounded-image" src="/assets/images/connectors/slack/FederatedSlackCredentials.png" alt="SlackBotToken" />
...
<img className="rounded-image" src="/assets/images/connectors/slack/SlackFederatedConnectorSetting.png" alt="SlackConnectorSetting" />
...
<img className="rounded-image" src="/assets/images/connectors/slack/FederatedSlackOauth.png" alt="SlackId" />
