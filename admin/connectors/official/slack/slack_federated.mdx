...
<img className="rounded-image" src="/assets/admin/connectors/slack/FederatedSlackCredentials.png" alt="Slack Basic Information page with Client ID and Client Secret" />
...
<Steps>
  ...
  <Step title="Configure search scope">
    ...
    **Search Parameters:**
    ...
    <img className="rounded-image" src="/assets/admin/connectors/slack/SlackFederatedConnectorSetting.png" alt="Onyx Slack Federated connector settings showing client credentials" />
  </Step>
...
<Info>
  ...
  1. The connector configuration settings (channels, DMs, private channels, etc.)
  2. The OAuth scopes granted during setup
  3. The user's individual access permissions in Slack
...
<img className="rounded-image" src="/assets/admin/connectors/slack/FederatedSlackOauth.png" alt="Slack OAuth consent screen for Onyx Search Assistant" />
