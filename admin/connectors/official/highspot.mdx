...
<img className="rounded-image" src="/assets/images/connectors/highspot/highspot_enable_developer.png" alt="Highspot company settings showing Access and Privacy with API access" />
...
<Steps>
  ...
  <Step title="Generate API key">
    ...
    <img className="rounded-image" src="/assets/images/connectors/highspot/highspot_generate_api.png" alt="Highspot user Developer settings generating an API key and secret" />
  </Step>
