...
![HighspotEnableDeveloper](/assets/images/connectors/highspot/highspot_enable_developer.png)
...
#### Generating API Credentials
    ...
    ![HighspotGenerateAPI](/assets/images/connectors/highspot/highspot_generate_api.png)
    6. Make a note of your API key, secret and base URL as you will need them for indexing

### Indexing

    1. Navigate to the Admin Panel and select the **Highspot** Connector Tile
