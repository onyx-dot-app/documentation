...
<Steps>
  ...
  <Step title="Enter base URL and index">
    ...
    <img className="rounded-image" src="/assets/images/connectors/web/WebConnector.png" alt="Onyx Web connector form to enter base URL for indexing" />
  </Step>
</Steps>

To see the status of the indexing, visit the Connectors Status page (top left).

<img className="rounded-image" src="/assets/images/connectors/web/WebConnectorStatus.png" alt="Onyx Connectors Status page showing web crawl progress" />
