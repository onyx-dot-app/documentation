...
<Update label="October 20th 2025" description="v2.0.0" tags={["New Features", "Deployment Changes", "Breaking Changes"]}>
  ...
  To filter the sources of your search results, click the Actions configuration button in the Chat Input Bar,
  ...
  We've added a single line deployment script to make it easier to deploy Onyx.
  This script will check your system resources and requirements and guide you through the necessary steps to deploy
  Onyx.

  Note, this script is intended for new users. For existing users,
