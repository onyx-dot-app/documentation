...
<Update label="v2.4.0" description="November 18th, 2025" tags={["New Features", "Performance", "Bug Fixes"]}>
  ...
  We've increased the per-file token limit for Projects to 100k.
  Additionally, you can configure this limit with the `SKIP_USERFILE_THRESHOLD` environment variable.
