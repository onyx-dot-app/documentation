...
<Update label="v2.7.0" description="January 7th, 2026" tags={["New Features", "Breaking Changes", "Bug Fixes"]}>
  ...
  <Info>
    If you've previously set up an image generaiton model via environment variables,
    you will need to create a new configuration via the Admin Panel's new page to continue generating images.
  </Info>
