...
<Update label="v2.10.0" description="January 31st, 2026" tags={["New Features", "Bug Fixes"]}>
  ...
  Instead of v2.11.0, the migration version will be **v3.0.0**.
  Our intention is that everyone must upgrade to a **v3.x.x** version before moving on to **v4.x.x**,
  where Vespa will be deprecated.

  <Tip>
    If you skip a v3 version, you will lose all of your indexed data!
    You will need to re-create your connectors and re-index.
  </Tip>
  ...
  To accomodate this change, the migration period has been pushed by 1 week:
  - **v3.0.0 Beta** will be released this week
  - **v3.0.0 Stable** is slated for the second week of February

  Lastly, we do not expect many minor versions of v3 before moving to v4.

  We will continue to share details, migration guides, and any changes to the plan as we get closer to **v3.0.0**!
