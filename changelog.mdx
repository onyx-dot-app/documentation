...
<Update label="v3.3.0" description="May 4th, 2026" tags={["New Features", "Bug Fixes", "Performance"]}>
  ...
  more accurately choose the right XLSX or CSV document, which the llm can then
  interpret. Tabular files are supported across the file upload path and the
  Google Drive, Blob, and SharePoint connectors.
