...
<Update label="v2.3.0" description="November 11th, 2025" tags={["Performance", "New Features", "Bug Fixes"]}>
  ...
  <img className="rounded-image" src="/assets/changelog/v2.3.0/showcase_personal_access_tokens.png" alt="Personal Access Tokens"/>
  ...
  <img className="rounded-image" src="/assets/changelog/v2.3.0/showcase_frontend_performance.png" alt="Frontend Performance Improvements"/>
