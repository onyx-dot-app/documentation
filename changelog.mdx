...
<Update label="v2.11.0" description="February 12th, 2026" tags={["New Features", "Bug Fixes"]}>
  ...
  and are now polishing bugs, improving the migration flow, and building out full feature parity.
  This release adds complete retrieval filtering, dual document indices, and OpenSearch Helm charts for Kubernetes deployments.

  We'll continue to share updates as we move toward the v3.0.0 release.
  ...
  Upload an image or choose from a selection of backgrounds in the new Backgrounds section of the Settings page.
  ...
  The Onyx Desktop App (introduced in [v2.6.0](#v2.6.0)) received several important updates in this release:
