...
<Update label="v2.4.0" description="November 18th, 2025" tags={["New Features", "Performance", "Bug Fixes"]}>
  ...
  <Note>
    If you have an existing Slack Federated Connector, you will need to update the app's scopes
    to use the expanded search functionality (e.g. searching group DMs).

    See the [Slack Federated Connector](/admin/connectors/official/slack/slack_federated/)
  ...
  Read more about LLM access controls in our [admin docs](/admin/advanced_configs/llm_access_controls/).
