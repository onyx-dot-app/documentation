...
<Card title="40+ Connectors" icon="plug" href="/admin/getting_started/connectors">
...
<Card title="Use Onyx Everywhere" icon="globe" href="/overview/use_onyx_where_you_work/web_interface">
  Access Onyx through web, Slack, Chrome extension, mobile app, and more - work where you're most productive.
</Card>

<Card title="Developer APIs" icon="code" href="/developers/overview">
