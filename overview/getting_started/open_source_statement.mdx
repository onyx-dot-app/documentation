...
We're builders at heart, committed to making Onyx valuable for as many people as possible. To push the boundaries of user experience and AI innovation, we've assembled a core team of world-class developers who share this vision.
...
We believe in radical transparency—both in how we build open software and in the commercial realities of competing in this rapidly evolving space.

<Tip>
  Every organization, regardless of size or budget, will always have access to Onyx's core capabilities—including RAG, deep research, custom agents, and more—completely free.
</Tip>

For organizations with special requirements—such as usage auditing, granular access controls, and white-labeling—we offer the Enterprise Edition, available both as a self-hosted solution and through Onyx Cloud.
