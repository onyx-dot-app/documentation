...
<AccordionGroup>
  <Accordion title="What kind of questions can I ask Onyx?">
    You can ask Onyx about knowledge from [connected applications](/overview/core_features/internal_search),
    general world knowledge known to the LLM,
  ...
  <Accordion title="How do I know if Onyx is right for me?">
    Onyx is built for teams of all sizes whether it's a global enterprise needing unified search across its knowledge or
    a single user looking for a local Chat UI.
