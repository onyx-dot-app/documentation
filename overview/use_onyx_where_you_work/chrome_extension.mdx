...
description: "Using the Onyx Chrome browser extension"
icon: "puzzle-piece"
---
...
1. Click the three dots (...) next to the Onyx extension
2. Select **Options**
3. Configure your preferences for search, bookmarks, and new tab behavior
