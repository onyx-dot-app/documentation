...
Craft is a free-form agent loop in a secure sandbox: you describe an outcome, and Craft plans the work,
pulls in context from your knowledge and connected tools, writes and runs code, and iterates until it's done.
Think of a coding agent like Claude Code or Codex, pointed at decks, reports, web apps, and documents.
...
A report or web app works the same way: name the sources and the output,
and Craft assembles it for you to review and refine.
