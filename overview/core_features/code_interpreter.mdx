...
- **Graph Rendering**: The Onyx [Chat UI](/overview/core_features/chat) is able to render returned graphs and other visualization for the user.

## Usage
The Code Interpreter does not need to be invoked explicitly, the LLM will determine when to use it depending on the user query.
