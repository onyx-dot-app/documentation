...
<Steps>
  ...
  <Step title="Start a Chat Session" icon="comment">
    Code Interpreter is available within the Chat interface. Start a new chat session
  ...
  <Step title="Review Results" icon="eye">
    Onyx will execute the code and show you the results, including any output,
    visualizations, or files generated.
  </Step>

  <Step title="Iterate and Refine" icon="arrows-spin">
    You can ask Onyx to modify the code, fix errors, or add new functionality
...
<Card title="Secure Environment" icon="shield-check">
  Code execution happens in a secure, sandboxed environment that protects your system
  and data from potentially harmful code.
</Card>
