...
Onyx Craft lets users create web applications, documents, presentations, and more from company knowledge using an AI coding agent in an isolated sandbox. Users describe what they want, and the agent builds artifacts using their indexed documents and uploaded files.
...
- Builds the backend image with Node.js and the opencode CLI
