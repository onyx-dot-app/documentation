...
- **Auto-send**: When enabled, your message is automatically sent when you pause speaking, so you don't need to click send.
...
- **Auto-playback**: When enabled, the microphone will automatically start listening again as soon as the response
  finishes speaking, enabling a continuous hands-free flow. When disabled, the response is generated as text
