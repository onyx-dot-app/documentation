...
Your Onyx administrators configure what sources are connected to Onyx. 
Additionally, your admins can selectively index data from a source such as indexing a single Jira project.
