...
Users do not need to explicitly select this mode — when a query is classified by Onyx as a document search, it will automatically go into this UI experience.
