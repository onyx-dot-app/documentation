...
Onyx Agents can be for individual use or shared with other users or [user-groups](/admin/user_management/groups)
within Onyx.
...
<Note>
  If any of the build-in actions (Web Search, Internal Search, Image Generation, Code Interpreter) are missing,
