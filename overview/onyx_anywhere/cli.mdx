...
Built with Go using [Bubble Tea](https://github.com/charmbracelet/bubbletea), it provides both an interactive TUI and non-interactive commands for scripting and automation.
...
```shell
go install <PLACEHOLDER_GO_MODULE_PATH>@latest
```

{/* TODO: Replace with actual Go package URL once published */}
...
<Tip>
  You can generate an API key from **Settings > API Keys** in the Onyx web interface.
</Tip>
