...
Onyx allows for highly flexible Slack configurations so that you use all of your Onyx Agents directly in your favorite channels.
...
<Tip>Try asking Onyx to summarize Threads by tagging the Onyx Slack Bot in the Thread!</Tip>

## Try it out
The Onyx Slack Bot is always live and serving answers to the community in our public Slack.

To test it out, join the [community Slack](https://join.slack.com/t/onyx-dot-app/shared_invite/zt-34lu4m7xg-TsKGO6h8PDvR5W27zTdyhA) and see the #ask-onyx channel or tag **@OnyxBot** from anywhere.
