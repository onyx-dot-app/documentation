...
<img className="rounded-image" src="/assets/overview/onyx_anywhere/slack.png" alt="Slack"/>
...
<img className="rounded-image" src="/assets/overview/onyx_anywhere/onyxbot.png" alt="OnyxBot"/>
