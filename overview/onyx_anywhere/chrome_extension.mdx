...
<Note>
  ...
  the full page you are currently on and optionally index the recent pages into
  the Onyx knowledge base.
</Note>
...
<Steps>
  ...
  <Step title="Open Options">Select **Options**</Step>
...
<Info>
  **Need help with setup?** Contact your Onyx administrator for installation
  assistance or configuration questions.
</Info>
